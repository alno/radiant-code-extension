...
You may specify preferred code processor in <tt>code.processor</tt> setting. Currently supported processors:
* <tt>ultraviolet</tt> - http://ultraviolet.rubyforge.org
* <tt>coderay</tt> - http://coderay.rubychan.de
* <tt>syntax</tt> - http://syntax.rubyforge.org
* <tt>highlight_js</tt>* - http://softwaremaniacs.org/soft/highlight - client-side library

You may specify theme in <tt>code.theme</tt> setting. Supported themes depends on selected processor.
